          ...
          <div className="md:col-span-7">
            ...
            >
              ...
              <h3 className="text-3xl md:text-5xl font-serif font-bold text-foreground mb-6 leading-tight">
                <Editable>
                  [Crafting experiences that blend form and function.]
                </Editable>
              </h3>
              <div className="prose prose-lg dark:prose-invert prose-p:text-muted-foreground mb-10">
                <p>
                  <Editable>
                    [Write 2–3 sentences about your background, your expertise, and what makes you unique. Focus on outcomes, not just titles. For instance: Over the past decade, I've transformed complex ideas into intuitive digital products used by millions. I bridge the gap between design and engineering, ensuring that every detail is executed with precision.]
                  </Editable>
                </p>
              </div>
